...
def get_url_for_year(year):
    ...
    #here's another way to do that same thing above, but simpler
...
def main():                                     #create a dictionary where key is year, value is
    ...
    for year in range(1, 86):
        ...
        category_data = {}
        for index, movie in enumerate(movies):  #enumerate gives you the position you're currently in + the value
