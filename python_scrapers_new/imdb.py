...
def get_movies(url):
    ...
    print response                                  # just learned about 'response' -- kinda like console.log 
    ...
    for each_url in url_list:                           #each_url means nothing right now, its just a consistent handle for me to iterate on as i go through my urls
